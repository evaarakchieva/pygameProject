...
while game_is_running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                ...
                bullet_x = fighter_x + fighter_width / 2 - bullet_width / 2
                bullet_y = fighter_y - bullet_height
    ...
    if bullet_was_fired and bullet_y + bullet_height < 0:
        bullet_was_fired = False
    ...
    if bullet_was_fired and \
            alien_x < bullet_x < alien_x + alien_width - bullet_width and \
            alien_y < bullet_y < alien_y + alien_height - bullet_height:
        bullet_was_fired = False
        alien_x, alien_y = randint(0, screen_width - alien_width), 0
